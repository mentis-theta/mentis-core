...
export const DocumentDuplicateIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2h-1m-4 5l-1-1" />
    </svg>
);

export const UserGroupIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-8 w-8  text-foreground-muted   "} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const ShieldCheckIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-8 w-8  text-foreground-muted   "} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const CurrencyDollarIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-5 w-5"} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.95-.754 2.227-.754 3.177 0l.879.659M7 12h10" />
    </svg>
);
...
export const ThumbDownIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-5 h-5"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.446 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904M10.133 10.5V3.75m-3.5 6.75l-1.07-1.07a.454.454 0 00-.639 0l-1.07 1.07H2.25a.75.75 0 00-.75.75v8.25c0 .414.336.75.75.75h4.383c.414 0 .75-.336.75-.75v-8.25a.75.75 0 00-.75-.75h-1.07z" />
    </svg>
);
...
export const WhatsappIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "w-5 h-5"} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.711 2.598 2.654-.698c.991.54 2.131.826 3.29.826 3.193 0 5.771-2.587 5.771-5.767s-2.586-5.766-5.765-5.766zm.004 3.415h-.006c.002 0 .004 0 .006.002v-.002zm2.147 3.321c-.09.255-.526.485-.72.551-.194.066-.452.083-1.472-.341-1.308-.544-2.152-1.89-2.218-1.977-.066-.088-.532-.708-.532-1.349 0-.642.336-.957.456-1.077.12-.12.261-.148.375-.148.093 0 .19.002.269.004.093.002.217-.03.336.255.127.304.433 1.059.471 1.135.039.076.066.166.01.266-.057.102-.087.166-.171.266-.084.1-.176.223-.252.3-.087.087-.179.182-.078.356.102.174.453.743.972 1.205.666.593 1.226.793 1.399.88.174.088.275.076.376-.04.102-.117.433-.504.549-.677.117-.174.237-.145.399-.087.162.057 1.026.482 1.202.57.177.087.295.13.339.206.044.076.044.441-.11.896zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" />
    </svg>
);
...
export const FilmIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m-3.75 0V5.625m0 12.75v-1.5c0-.621.504-1.125 1.125-1.125m18.375 2.625V5.625m0 12.75c0 .621-.504 1.125-1.125 1.125m1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125m0 3.75h-1.5A1.125 1.125 0 0 1 21 18.375m-1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125m-3.75 3.75h-1.5A1.125 1.125 0 0 1 13.5 18.375m-1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125m-3.75 3.75h-1.5A1.125 1.125 0 0 1 6 18.375m-1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125M12 18.75a3.375 3.375 0 1 0 0-6.75 3.375 3.375 0 0 0 0 6.75Z" />
    </svg>
);
...
export const FireIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.601a8.983 8.983 0 013.361-6.866 8.28 8.28 0 003 2.48z" />
